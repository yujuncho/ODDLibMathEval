...
// ODDLibMathEval
#define COCOAPODS_POD_AVAILABLE_ODDLibMathEval
#define COCOAPODS_VERSION_MAJOR_ODDLibMathEval 0
#define COCOAPODS_VERSION_MINOR_ODDLibMathEval 1
#define COCOAPODS_VERSION_PATCH_ODDLibMathEval 0
